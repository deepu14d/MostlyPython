...
def run_it():
    ...
    try:
        command = recognizer.recognize_google(recordedaudio, language='en')
        command = command.lower()
        if 'botty' in command:
            command = command.replace('botty', '')
        ...
        if 'hello' in command:
            ...
            print('I am Botty, your virtual assistant master')
            engine_talk('I am Botty, your virtual assistant master. how can i help you ??')
...
print('\n')
print("hello, i am Botty how can i help you ??")
engine_talk("hello i am Botty how can i help you ")
